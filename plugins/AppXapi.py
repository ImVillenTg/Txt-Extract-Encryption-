...
async def start(bot, m):
    ...
    for topic in topicid:
        ...
        for tsids in tsids_list:
            scraper = cloudscraper.create_scraper()            
            html5 = scraper.get("https://"+raw_text05+"/get/livecourseclassbycoursesubtopconceptapiv3?courseid=" + raw_text1 + "&subjectid=" + tids + "&topicid=" + tsids + "&conceptid=1&start=-1", headers=hdr).content
