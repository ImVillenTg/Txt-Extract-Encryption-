...
async def start(bot, m):
    ...
    if "*" in raw_text:
    	...
    	html = scraper.post("https://"+API+"/post/userLogin",data,headers=login_hdr).content
    ...
    scraper = cloudscraper.create_scraper()
    html1 = scraper.get("https://"+API+"/get/mycourse?userid=" + userid, headers = hdr).content
    ...
    for data in topicid:
        ...
        for topic in topicid:
            ...
            for data in vv:
                ...
                tsids_list.append((tsids, topic_title))
